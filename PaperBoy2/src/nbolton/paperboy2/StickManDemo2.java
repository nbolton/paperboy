...
public class StickManDemo2 implements ApplicationListener, InputProcessor {
	...
	private void createStickMan() {
		...
		Body box1 = createBox(1.5f, 4);
		Body box2 = createBox(-1.5f, 4);
		
		RevoluteJointDef jointDef = new RevoluteJointDef();
		jointDef.initialize(box1, box2, box1.getWorldPoint(new Vector2(0.9f, 0)));
